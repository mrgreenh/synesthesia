...
define(["views/visualizer/actors/CanvasActor"], function (CanvasActor) {
    var CanvasCircle = (function (_CanvasActor) {
        _inherits(CanvasCircle, _CanvasActor);

        _createClass(CanvasCircle, null, [{
            key: "getActorParameters",
            value: function getActorParameters() {
                return _get(Object.getPrototypeOf(CanvasCircle), "getActorParameters", this).call(this).concat(["size"]);
            }
        }]);
